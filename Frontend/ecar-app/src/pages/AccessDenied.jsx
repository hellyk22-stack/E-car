...
const AccessDenied = () => {
    ...
    const role = getRole()
    const homeTarget = role === 'admin' ? '/admin/managecars' : '/user/search'

    return (
        <div className="min-h-screen flex items-center justify-center px-6" style={{ background: 'radial-gradient(circle at top, rgba(99,102,241,0.16), transparent 35%), #0a0a0f', fontFamily: "'Syne', sans-serif" }}>
            <div className="w-full max-w-xl rounded-3xl border border-white/10 bg-slate-900/80 p-10 text-center shadow-2xl backdrop-blur-xl">
                ...
                <div className="flex flex-wrap justify-center gap-3">
                    <button
                        ...
                        className="rounded-xl bg-gradient-to-r from-indigo-500 to-violet-600 px-6 py-3 text-sm font-semibold text-white transition hover:from-indigo-400 hover:to-violet-500"
                    >
                        Go to Dashboard
                    </button>
                    <button
